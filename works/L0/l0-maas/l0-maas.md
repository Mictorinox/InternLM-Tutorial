...
进入 codespace 之后，我们新建源文件 “L-download.ipynb” 并安装依赖包
...
#### 3.1 将托管仓库链接到服务器（以GitHub Codespace为例）
...
在git push之前，需要在Hugging Face Space设置登录Token[参考链接](https://huggingface.co/blog/zh/password-git-deprecation)
